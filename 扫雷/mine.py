...
class Mines(Frame):  
    ...
    def createWidgets(self):  
        ...
        self.rowconfigure(self.model.height,weight=2)  
        self.columnconfigure(self.model.width,weight=2)  
        self.buttongroups=[[Button(self,height=1,width=3) for i in range(self.model.width)]  
